        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_associations_accounts_id",
                        column: x => x.id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_assisted_people", x => x.id);
                    table.ForeignKey(
                        name: "fk_assisted_people_persons_created_by",
            ...
            migrationBuilder.CreateTable(
                name: "caregiver_assisted_links",
                columns: table => new
                {
                    caregiver_id = table.Column<Guid>(type: "uuid", nullable: false),
                    assisted_person_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    deleted_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_caregiver_assisted_links", x => new { x.caregiver_id, x.assisted_person_id });
                    table.ForeignKey(
                        name: "fk_caregiver_assisted_links_assisted_people_assisted_person_id",
                        column: x => x.assisted_person_id,
                        principalTable: "assisted_people",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_caregiver_assisted_links_persons_caregiver_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_transport_requests_assisted_people_beneficiary_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_kind = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_trip_operator_links", x => x.id);
                    table.ForeignKey(
                        name: "fk_trip_operator_links_transport_requests_transport_request_id",
                        column: x => x.transport_request_id,
                        principalTable: "transport_requests",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_assisted_people_created_by",
                table: "assisted_people",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "ix_caregiver_assisted_links_assisted_person_id",
                table: "caregiver_assisted_links",
                column: "assisted_person_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_failed_login_attempts_email_attempted_at",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_trip_operator_links_token",
                table: "trip_operator_links",
                column: "token",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_trip_operator_links_transport_request_id",
                table: "trip_operator_links",
                column: "transport_request_id");
