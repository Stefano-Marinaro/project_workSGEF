...
public static class DependencyInjection
{
    ...
    {
        services.AddSingleton<IClock, SystemClock>(); // per tutto il ciclo di vita dell'app, si usa per oggetti senza stato, thread-safe (è sicuro che piu thread lo tocchino)
